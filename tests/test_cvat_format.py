...
DUMMY_IMAGE_DATASET_DIR = osp.join(
    osp.dirname(__file__), "assets", "cvat_dataset", "for_images"
)

DUMMY_VIDEO_DATASET_DIR = osp.join(
    osp.dirname(__file__), "assets", "cvat_dataset", "for_video"
)
                ...
                DatasetItem(
                    ...
                    annotations=[
                        Bbox(
                            ...
                            label=0,
                            z_order=1,
                            attributes={"occluded": True, "a1": True, "a2": "v3"},
                        ),
                        PolyLine(
                            [1, 2, 3, 4, 5, 6, 7, 8], attributes={"occluded": False}
                        ),
                    ],
                    attributes={"frame": 0},
                ),
...
class CvatConverterTest(TestCase):
    ...
    def test_can_save_and_load(self):
        ...
        source_dataset = Dataset.from_iterable(
            [
                DatasetItem(
                    ...
                    annotations=[
                        ...
                        Points(
                            [1, 1, 3, 2, 2, 3],
                            label=2,
                            attributes={"a1": "x", "a2": 42, "unknown": "bar"},
                        ),
                        Label(1),
                ...
                DatasetItem(id=3, subset="s3", image=Image(path="3.jpg", size=(2, 4))),
            ],
            categories={
            ...
            [
                DatasetItem(
                    ...
                    annotations=[
                        ...
                        Points(
                            [1, 1, 3, 2, 2, 3],
                            label=2,
                            attributes={"occluded": False, "a1": "x", "a2": 42},
                        ),
                        Label(1),
                        Label(2, attributes={"a1": "y", "a2": 44}),
                    ],
                ...
                DatasetItem(
                    ...
                    annotations=[
                        ...
                        Bbox(
                            5, 0, 1, 9, label=3, group=4, attributes={"occluded": False}
                        ),
                    ],
                    attributes={"frame": 1},
                ),
    ...
    def test_relative_paths(self):
        ...
        target_dataset = Dataset.from_iterable(
            [
                DatasetItem(id="1", image=np.ones((4, 2, 3)), attributes={"frame": 0}),
                DatasetItem(
                    id="subdir1/1", image=np.ones((2, 6, 3)), attributes={"frame": 1}
                ),
                DatasetItem(
                    id="subdir2/1", image=np.ones((5, 4, 3)), attributes={"frame": 2}
                ),
            ],
            categories={AnnotationType.label: LabelCategories()},
        )
    ...
    def test_preserve_frame_ids(self):
        expected_dataset = Dataset.from_iterable(
            [
                DatasetItem(
                    id="some/name1", image=np.ones((4, 2, 3)), attributes={"frame": 40}
                ),
            ],
            categories={AnnotationType.label: LabelCategories()},
        )
    ...
    def test_reindex(self):
        ...
        expected_dataset = Dataset.from_iterable(
            [
                DatasetItem(
                    id="some/name1", image=np.ones((4, 2, 3)), attributes={"frame": 0}
                ),
            ],
            categories={AnnotationType.label: LabelCategories()},
        )
