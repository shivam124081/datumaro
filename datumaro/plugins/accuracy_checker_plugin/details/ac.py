...
class GenericAcLauncher:
    ...
    def __init__(
        self, launcher, adapter=None, preproc=None, postproc=None, input_feeder=None
    ):
    ...
    def launch_raw(self, inputs):
        ...
        inputs = [
            DataRepresentation(inp, identifier=id) for id, inp in zip(ids, inputs)
        ]
    ...
    def launch(self, inputs):
        ...
        return [
            import_predictions(g)
            for _, g in groupby(outputs, key=lambda o: o.identifier)
        ]
